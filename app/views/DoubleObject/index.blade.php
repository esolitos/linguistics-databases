...
@section("content")
	...
	<ul>
		...
		<li><a href="{{ action('OccurrenceController@create') }}">Insert New <em>Object Property</em></a>: you will define a new "Property" that will subsequently used in the Occurrence insertion.</li>
		<li><a href="insert.php?what=occurrence">Insert New Occurrence</a>: define a new Occurrence/Istance in a specific Category and its Objects' properties.<br><small>(Note that the <u>Occurrence Category</u> and <u>Object Properties</u> must of this Occurrence <strong>must be already defined</strong>!)</small></li>
