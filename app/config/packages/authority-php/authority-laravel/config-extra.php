...
return [
    ...
    'initialize' => function (Authority\Authority $authority) {
        ...
        $perm->type = Permission::ALLOW;
        $perm->action = Permission::ACTION_R;
        $perm->resource = User::class;
        $perm->save();
        ddd($perm);
        */
        ...
        //$authority->allow('read', 'all', function ($self, $user) {
        //    ddd(func_get_args());
        //    return $self->id !== 0 && $self->user()->id === $user->id;
        //});
